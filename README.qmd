|  |
|----|
| tle: "Activity 11: Statistical reasoning 3: multiple regression and DAGs" |
| btitle: Feb. 11th, 2026, Calvin Munson |
| rmat: gfm |
| ecute: |
| warning: false |
| itor: source |
...
food_on_area <- brm(avgfood ~ 1 + area, 
                    ...
                    prior = c(prior(normal(6, 0.3), class = Intercept),
...
We want to condition on group size and area.
...
I think group size effects average food availability because they would have a greater territory they could get food from. Less individual resources more competition when they are in a bigger group. But its a trade off that they can have larger territory and more protection.
...
We can conclude our hypothesis, that average food is positively correlated with weight, and large groups make smaller foxes. The slope for average food was positive, meaning more food meant more weight. While the slope for group size was negative so larger groups means less weight.
